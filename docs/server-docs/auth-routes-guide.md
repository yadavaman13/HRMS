...
The auth module mounts routes under three base paths in [`app.js`](file:///c:/Users/Aman/Desktop/apex-template/server/src/app.js):

- **Auth Base API:** `/api/auth` (mounted to [`authRouter`](file:///c:/Users/Aman/Desktop/apex-template/server/src/modules/auth/routes/auth.routes.js))
- **User Base API:** `/api/users` (mounted to [`userRouter`](file:///c:/Users/Aman/Desktop/apex-template/server/src/modules/auth/routes/user.routes.js))
- **Admin Base API:** `/api/admin` (mounted to [`adminRouter`](file:///c:/Users/Aman/Desktop/apex-template/server/src/modules/auth/routes/admin.routes.js))
...
All routes require authentication via the [`protect`](file:///c:/Users/Aman/Desktop/apex-template/server/src/modules/auth/middleware/auth.middleware.js) middleware.
...
These administrative routes require both [`protect`](file:///c:/Users/Aman/Desktop/apex-template/server/src/modules/auth/middleware/auth.middleware.js) and [`restrictTo('admin')`](file:///c:/Users/Aman/Desktop/apex-template/server/src/modules/auth/middleware/auth.middleware.js) middlewares.
...
Add validation sequences to [`src/modules/auth/validators/auth.validator.js`](file:///c:/Users/Aman/Desktop/apex-template/server/src/modules/auth/validators/auth.validator.js):
...
2. Mount the router in the module index (`src/modules/auth/index.js`):
    ...
    ```
3. Expose the router in the primary express router mount pipeline ([`src/app.js`](file:///c:/Users/Aman/Desktop/apex-template/server/src/app.js)):
    ```js
