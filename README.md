...
Welcome to the **Dayflow Human Resource Management System (HRMS)** database and architecture repository.

## 📚 Documentation & Schema Files

- **[ARCHITECTURE_AND_FLOWS.md](file:///d:/odoo/hrms/HRMS/ARCHITECTURE_AND_FLOWS.md)**:
...
- **[database_schema.sql](file:///d:/odoo/hrms/HRMS/database_schema.sql)**:
